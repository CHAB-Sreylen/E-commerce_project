<template>
    <div class="flex flex-col mb-10">
        <div class="w-[330px] h-[450px] bg-[#FFF2F2] flex flex-col relative">
            ...
            <div class="w-full flex absolute top-10 justify-center ">
                <img class="Img w-[300px] h-[350px] " :src="img"  alt="" />
            </div>
        </div>
        <p class="name font-[400] text-[20px] ml-3 mt-4">{{ name }}</p>
        <p class="price font-[400] text-[14px] ml-3 mt-4">{{ price }}</p>
    </div>
